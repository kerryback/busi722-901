...
- Example: maybe the market expected on 1-24-2022 that gold would hit $2,000 by the end of 2028.
...
- Example: If we think gold will hit $2,000 in 7 years and it is trading at $500 today, then we should all be buying gold today (quadruple our money in 7 years).
- This drives up the spot price to the point that we would only get a "normal" return on spot gold.

##

- Ignoring risk and risk premia, if we think gold will hit $2,000 in 7 years, then today's spot price should be $\text{2,000} / (1+r)^7$.

. . .

$$\text{spot}\! =\! \frac{\text{futures}}{(1+r)^7} \; \Leftrightarrow \; \text{futures} \!=\! \text{spot}\! \times\! (1+r)^7$$
