...
- To find the industry for a given SIC code, find the range in which the SIC code lies.
...
- The advantage of putting transformations in a pipeline with a model is that the exact same transformations will be automatically applied to new data when predictions are made.
- sklearn code is 
